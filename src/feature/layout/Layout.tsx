...
export default function Layout({ children }: LayoutProps) {
    ...
    const [alertSeverity, setAlertSeverity] = useState<AlertMessageSeverity>(AlertMessageSeverity.INFO);
    ...
    return (
        <UIContext.Provider value={contextValue}>
            <Box sx={{ display: "flex", flexDirection: "column", minHeight: "100vh" }}>
                ...
                <AlertMessage open={alertOpen} message={alertMessage} severity={alertSeverity} onClose={hideAlert} />
                <ConfirmDialog
                    open={confirmOpen}
                    title={confirmTitle}
